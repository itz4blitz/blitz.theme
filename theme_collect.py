...
BUILTIN_PRESETS: dict[str, dict] = {
    ...
    "clear-glass": {
        "label": "Clear Glass",
        "description": "Invisible bar, softened text, solid dropdowns.",
        "keys": {
            "bar.background": "transparent",
            "bar.background-alpha": 0.0,
            "bar.text": "__dim_0.12__",
            "bar.active": "urgent",
            "popups.background": "background",
            "popups.background-alpha": 0.96,
            "popups.text": "foreground",
            "popups.border": "accent",
            "popups.border-alpha": 0.55,
            "menu.background-alpha": 0.96,
            "tooltip.background-alpha": 0.96,
            "notifications.background-alpha": 0.96,
    ...
    "frost": {
        ...
        "keys": {
            ...
            "bar.text": "__dim_0.08__",
            "bar.active": "urgent",
            "popups.background": "background",
            "popups.background-alpha": 0.86,
            "popups.text": "foreground",
            "popups.border": "accent",
            "popups.border-alpha": 0.7,
            "menu.background-alpha": 0.86,
            "tooltip.background-alpha": 0.9,
            "notifications.background-alpha": 0.9,
            "controls.normal-border-width": 1,
    ...
    "whisper": {
        "label": "Whisper",
        "description": "Clear bar, whisper-dim text, borderless translucent panels.",
        "keys": {
            "bar.background": "transparent",
            "bar.background-alpha": 0.0,
            "bar.text": "__dim_0.28__",
            "bar.active": "urgent",
            "popups.background": "background",
            "popups.background-alpha": 0.72,
            "popups.text": "__dim_0.05__",
